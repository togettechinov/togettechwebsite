...
<head>
    ...
    <title>CLATECH Event Services - Reset Password</title>
    <style type="text/css">
        /* RESET STYLES */
                                                                    ...
                                                                    <tr>
                                                                        <td class="textContent">
                                                                            <div style="text-align:center;">
                                                                                <a href="{{mob_route('welcome')}}">
                                                                                    <img style="max-width: 160px; text-align: right;" src="{{mob_asset('images/logo.png')}}" alt="">
                                                                                </a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            ...
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">You are receiving this email because we received a password reset request for your account.</div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                                        <tr>
                                                            <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{$actionUrl}}" target="_blank">{{__('Password Reset')}}</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="left" valign="top" class="flexibleContainerBox">
                                                                <table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent" style="font-size: 10px !important;">
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                ...
                                                                                <p>Regards, <br> Event Services Team</p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; 2020 <a href="{{mob_route('welcome')}}" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">CLATECH Wedding Services</span></a>. All&nbsp;rights&nbsp;reserved.</div>
